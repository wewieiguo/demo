  ...
  return (
    <div className={styles["border-container"]}>
      <div className={styles["border-define-container"]}>
        ...
        <ul>
          <li>
            语法：border-image: source slice width outset
        ...
        <ul>
          ...
          <li>
            注意：boxShadow
            属性把一个或多个下拉阴影添加到框上。该属性是一个用逗号分隔阴影的列表，每个阴影由
            2-4 个长度值、一个可选的颜色值和一个可选的 inset
            关键字来规定。省略长度的值是 0。
          </li>
      ...
      <div className={styles["border-example-container"]}>
        ...
        <div className={styles["border-img-stretch-content"]}>
          stretch（拉伸）
        </div>
